...
using AUTO.Argon.DotNetCore.Free.Data;
using AUTO.Argon.DotNetCore.Free.Infrastructure;
using AUTO.Argon.DotNetCore.Free.Infrastructure.ApplicationUserClaims;
using AUTO.Argon.DotNetCore.Free.Infrastructure.AppSettingsModels;
using AUTO.Argon.DotNetCore.Free.Models.Identity;
...
using AUTO.Argon.DotNetCore.Free.Infrastructure.Startup;

namespace AUTO.Argon.DotNetCore.Free
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.Cookie.Name = "AUTO.Argon.DotNetCore.AppCookie";
            ...
            services.AddSession(options =>
            {
                ...
                options.Cookie.Name = "AUTO.Argon.DotNetCore.SessionCookie";
                // You might want to only set the application cookies over a secure connection:
                // options.Cookie.SecurePolicy = CookieSecurePolicy.Always;
                options.Cookie.SameSite = SameSiteMode.Strict;
                options.Cookie.HttpOnly = true;
